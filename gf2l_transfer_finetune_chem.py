...
def train(model, device, loader, optimizer, criterion):
    ...
    for step, batch in enumerate(loader):
        ...
        pred = model(batch.x, batch.edge_index, batch.edge_attr, batch.batch, 'low-pass')
...
def arg_parse():
    ...
    parser.add_argument('--input_model_file', type=str, default='./models_gf2l/chem/pretrain_gf2l_encoder_epoch_1.pth',
...
if __name__ == "__main__":
    ...
    for dataset in data_list:
        ...
        logging.info('lr: {:.6f};  dropout_ratio: {:.2f};  graph_pooling {}'.format(lr, dropout_ratio, graph_pooling))
